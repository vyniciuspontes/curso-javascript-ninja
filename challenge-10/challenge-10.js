...
function doCalculation(operationSignal, operation){
...
doCalculation(operationSignal, sum);
...
doCalculation(operationSignal, sub);

operationSignal = '*';
var mult = calculator(operationSignal);
doCalculation(operationSignal, mult);

operationSignal = '/';
var div = calculator(operationSignal);
doCalculation(operationSignal, div);

operationSignal = '%';
var mod = calculator(operationSignal);
doCalculation(operationSignal, mod);
...
doCalculation(operationSignal, invalid);
