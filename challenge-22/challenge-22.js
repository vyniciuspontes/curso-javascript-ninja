(function (){
  ...
  */
  ...
  console.log(sum(5, 5, 5, 1, 2, 5));
  console.log(sum(5, 5));
  console.log(sum.apply(sum, [2, 5]));
  ...
  */
  ...
  var cleanEntry = justNumbers(userEntry);
  console.log(cleanEntry);

  var result = sum.apply(sum, cleanEntry);
  console.log(result);
