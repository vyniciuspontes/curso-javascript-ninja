...
var fruits = ['Banana', 'Mango', 'Pineapple', 'Pear', 'Apple']

console.log( 'O array em formato de string é:', fruits.toString() );
...
var sudeste = ['Minas Gerais', 'Espirito Santo', 'Rio de Janeiro',
  'São Paulo'];
...
*/
var nordeste = [' Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Piauí',
...
console.log( every ?
  "Sim, todos os estados tem mais de 7 letras!" : "Nem todos os estados " +
    "tem mais de 7 letras!");
...
*/
var filter = newBrasil.filter(
  function (item, index, array) {
    console.log(`\n${item.id} has index: ${index}`);
    return (item.id % 2 === 0);
  }
);
