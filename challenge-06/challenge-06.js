...
*/
var championship = function(championshipName){
...
var teams = ['vasco', 'flamengo', 'fluminense', 'botafogo', 'bangu'];
...
function convertToHex(colorName){
  ...
  switch (colorName) {
    ...
    case 'yellow':
        hexa = "#ffff00";
      break;
    default: return "Não temos o equivalente hexadecimal para " + colorName + ".";
  }
