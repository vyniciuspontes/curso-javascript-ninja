...
pessoa.andar = function (metrosCaminhados){
  ...
  if (metrosCaminhados === undefined){
    return "Adicione os metros caminhados";
  }
...
*/
//Olá, meu nome é Vynicius Pontes
...
pessoa.apresentacao = function (){
  ...
  return "Olá, eu sou " + artigoNome + " " + this.nome + " " + this.sobrenome + ",tenho " + this.idade +" ano" + pluralIdade + ", "
    + this.altura +", meu peso é " + this.peso  + " e, só hoje, eu já caminhei " + this.caminhouQuantosMetros + " metro" + pluralMetros +"!";
