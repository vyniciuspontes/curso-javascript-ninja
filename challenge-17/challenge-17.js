...
console.log(text.replace(/Manuel Marques de Sousa/, 'Vynicius Morais Pontes'));
...
console.log(text.replace(/O Centauro de Luvas/g,
  function(completeString) {
    return completeString.toUpperCase();
  }
));
...
function getMonthNumber(month) {
  ...
  var returnNumber = months.indexOf(month) + 1;

  return (returnNumber > 9 ? '' + returnNumber : '0' + returnNumber);
}
